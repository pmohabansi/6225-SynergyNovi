...
/**
 * Created by aparm on 9/26/2017.
 */

public class ColorSensorRunnable implements Runnable {
    NormalizedColorSensor colorSensor;
    View relativeLayout;
    ThreadTest m_tt = null;

    public ColorSensorRunnable ( ThreadTest tt) {
        m_tt = tt;
    }
    public void run() {
        int relativeLayoutId = m_tt.hardwareMap.appContext.getResources().getIdentifier("RelativeLayout", "id", m_tt.hardwareMap.appContext.getPackageName());
        relativeLayout = ((Activity) m_tt.hardwareMap.appContext).findViewById(relativeLayoutId);

        try {
            runColorSensor(); // actually execute the sample
        } catch (Exception e) {}
        finally {
    ...
    protected void runColorSensor() throws InterruptedException {
        ...
        colorSensor = m_tt.hardwareMap.get(NormalizedColorSensor.class, "sensor_color");
...
//        m_tt.waitForStart();
        ...
        while (m_tt.opModeIsActive()) {
            // Check the status of the x button on the gamepad
            bCurrState = m_tt.gamepad1.x;
            ...
            m_tt.telemetry.addLine("raw Android color: ")
            ...
            m_tt.telemetry.addLine("normalized color:  ")
                    .addData("a", "%02x", Color.alpha(color))
                    .addData("r", "%02x", Color.red(color))
                    .addData("g", "%02x", Color.green(color))
                    .addData("b", "%02x", Color.blue(color));
            m_tt.telemetry.update();
